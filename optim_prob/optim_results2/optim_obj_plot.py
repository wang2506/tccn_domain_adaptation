...
ax.plot(obj_vals[1][:50],marker='x',linestyle='dashdot',c='darkblue',\
              label='Source Errors: '+str([np.round(i,2) for i in hat_ep_vals[1][:5]]))
ax.plot(obj_vals[2][:50],marker='x',linestyle='dotted',c='darkgreen',\
...
plt.savefig(cwd+'/conv_obj2.pdf',bbox_inches='tight',dpi=1000)
...
plt.savefig(cwd+'/conv_psi2.pdf',bbox_inches='tight',dpi=1000)
